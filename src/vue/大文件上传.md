...
![图片](https://mmbiz.qpic.cn/mmbiz_png/TZL4BdZpLdjtBH47Z0ibFHyCtGNuRdu8CxArbkSP8DLibNC8O93iaxeGS5ZGT32cWRcFztvx1bia4C3x1lGSvYFTaQ/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

我们可以通过一个小案例来体现出这个问题，我们先准备一个 excel 文件，它差不多有 1w 行数据

![图片](https://mmbiz.qpic.cn/mmbiz_png/TZL4BdZpLdjtBH47Z0ibFHyCtGNuRdu8CcGBADuSyKVyjO16zkJqXibTFzd7GggPE4oBOtD2icNsEgj288hwSW2eQ/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_gif/TZL4BdZpLdjtBH47Z0ibFHyCtGNuRdu8C6dlmsE9deKnxPGC0Pevzu12g6F2q3OYR4xhIA8f7yeT0NHnqNEpdfg/640?wx_fmt=gif&tp=wxpic&wxfrom=5&wx_lazy=1)

## `WebWorker`解决导入

这个问题可以用 WebWorker 来解决，WebWorker 能开启一个子线程，来做一些我们需要让它做的事情，并把结果返回到主线程，这样就可以不阻塞主线程的代码执行了~

![图片](https://mmbiz.qpic.cn/mmbiz_png/TZL4BdZpLdjtBH47Z0ibFHyCtGNuRdu8CARgqeAlj7IgoUuVIw7nmDeNRm82LI9XAEsJfmJHfjhqCQHNI2vn9SQ/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_gif/TZL4BdZpLdjtBH47Z0ibFHyCtGNuRdu8CIXPjedvlAmZ6ZFL6LxPNYvEvJdWNNSBGPLAN19heMHZKvlxlWTsyJA/640?wx_fmt=gif&tp=wxpic&wxfrom=5&wx_lazy=1)
